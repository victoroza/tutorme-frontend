...
AuthenticationService.$inject = ['$http', '$cookieStore', '$rootScope', '$timeout', '$q'];
function AuthenticationService($http, $cookieStore, $rootScope, $timeout, $q) {
	var service = {};
...
>>>>>>> b71d6daabf3bb47bb9d0a4230dfd02652fb816eb
